...
public class LoteController {
    ...
    public ResponseEntity<LoteDTO> getLoteById(@PathVariable @NonNull Integer id) {
    ...
    public ResponseEntity<LoteDTO> createLote(@Valid @RequestBody @NonNull CreateLoteRequest request) {
        return ResponseEntity.ok(loteService.save(request));
    }

    @PutMapping("/{id}")
    @Operation(summary = "Actualizar lote")
    public ResponseEntity<LoteDTO> updateLote(@PathVariable @NonNull Integer id, @Valid @RequestBody @NonNull CreateLoteRequest request) {
    ...
    public ResponseEntity<List<LoteDTO>> getLotesByFinca(@PathVariable @NonNull Integer fincaId) {
